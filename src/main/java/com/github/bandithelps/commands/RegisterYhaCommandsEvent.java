...
public class RegisterYhaCommandsEvent extends Event {
    private final LiteralArgumentBuilder<CommandSourceStack> builder;
    private final CommandBuildContext context;

    public RegisterYhaCommandsEvent(LiteralArgumentBuilder<CommandSourceStack> builder, CommandBuildContext context) {
